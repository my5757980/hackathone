...
export default function HeroSection(){
   return(
    <div className="max-w-[1920px] h-auto overflow-hidden ">
         <Image className="relative left-[300px] bottom-[-150px]" src="/image/BG.png" alt="logo" width={860} height={850}/>
        <div className="relative bottom-[-166px]">
        ...
        <button className=" relative bottom-[355px] left-[390px] flex gap-[14px] w-[171px] h-[52px] rounded-[8px] pt-[19px] pr-[24px] pb-[14px] pl-[31px] bg-[#029FAE]">
          ...
          <div className=" flex justify-between items-center w-[860px] h-[139px] relative left-[300px] bottom-[14px]">
